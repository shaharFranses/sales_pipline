...
def run_sales_elt():
    ...
    #creating raw table  for all the data before data quality checks
    ...
    ##data integrity checks - crating a msking object to filter out bad rows
    bad_rows_mask = (
    ...
    #third step T- transform , take data from raw table and insert it into final table with upsert logic-
    #updating old data and inserting new data
    sql_upsert_logic = """
